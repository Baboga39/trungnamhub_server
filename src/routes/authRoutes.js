...
router.post("/register", middlewares.authLimiter, middlewares.validation(registerSchema), authController.register);
router.post("/login", middlewares.authLimiter, middlewares.validation(loginSchema), authController.login);
